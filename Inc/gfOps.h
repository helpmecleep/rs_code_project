...
/**
 * @brief This function generates the cyclotomic cosets modulo n.
 * Each coset is generated by repeatedly multiplying the starting element by 2 and taking modulo n
 * until a return to the starting element is achieved.
 */
...
/**
 * This function retrieves the minimal polynomials given a field size m and an exponent.
 */
